...
enum PrimitiveType{PrimitiveType_INVALID, PrimitiveType_Sphere, PrimitiveType_Cloud, PrimitiveType_Pyroclastic};
...
public:
	...
	unsigned int    getPrimitiveCount()     { return m_primitiveCount; }    //The number of primitives
	Primitive*		getPrimitiveArray()		{ return m_primitives; }		//The primitive list
