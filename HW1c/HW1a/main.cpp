...
int main(int argc, char** argv)
{
	...
	myCamera.renderRayMarching(w, h, myConfig.getBackgroundColor(), myConfig.getMaterialColor(), myConfig.getOutputFileName(), voxelData, myConfig.getStep(), myConfig.getLightPosition(), myConfig.getLightColor());
